...
function baseKpiResult(overrides: Partial<ComplaintKpiResult> = {}): ComplaintKpiResult {
  return {
    kpis: {
      ...
      slaComplianceRate: { currentValue: 87, previousValue: null, absoluteChange: null, percentageChange: null, trend: "none", direction: "neutral" },
      closedWithinSlaCount: { currentValue: 70, previousValue: null, absoluteChange: null, percentageChange: null, trend: "none", direction: "neutral" },
      closedWithoutTrustedDateCount: { currentValue: 0, previousValue: null, absoluteChange: null, percentageChange: null, trend: "none", direction: "neutral" },
