...
export const RESTRUCTURE_ERROR_CODES = {
  ...
  CLASSIFICATION_TAXONOMY_CHANGED_AFTER_PREVIEW:
    "CLASSIFICATION_TAXONOMY_CHANGED_AFTER_PREVIEW",
  REACTIVATION_STATE_CHANGED_AFTER_PREVIEW: "REACTIVATION_STATE_CHANGED_AFTER_PREVIEW",
  ...
  TAXONOMY_RENAME_COLLISION: "TAXONOMY_RENAME_COLLISION",
  PLAN_NOT_APPLICABLE: "PLAN_NOT_APPLICABLE",
  CLASSIFICATION_WITH_COMPLAINTS_CANNOT_BE_DEACTIVATED:
    "CLASSIFICATION_WITH_COMPLAINTS_CANNOT_BE_DEACTIVATED",
  CATEGORY_WITH_COMPLAINTS_CANNOT_BE_DEACTIVATED:
    "CATEGORY_WITH_COMPLAINTS_CANNOT_BE_DEACTIVATED",
  AMBIGUOUS_CLASSIFICATION_MIGRATION: "AMBIGUOUS_CLASSIFICATION_MIGRATION",
