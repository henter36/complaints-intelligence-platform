...
function makeV2Brief(overrides: Partial<ExecutiveBriefV2Data> = {}): ExecutiveBriefV2Data {
  return {
    ...
    topClassifications: [
      { classificationId: "c1", classificationName: "نقل", categoryId: "cat-c1", categoryName: "فئة", classificationPath: "فئة / نقل", currentCount: 30, previousCount: 25, difference: 5, changeRate: 20, shareOfTotal: 30 },
      { classificationId: "c2", classificationName: "علاج", categoryId: "cat-c2", categoryName: "فئة", classificationPath: "فئة / علاج", currentCount: 20, previousCount: 0, difference: 20, changeRate: null, shareOfTotal: 20 },
      {
      ...
      deptClassRises: [
        {
          ...
          classificationId: "c1", classificationName: "فئة / نقل",
          currentCount: 10,
          previousCount: 2,
          difference: 8,
          changeRate: 400,
