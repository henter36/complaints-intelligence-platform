...
function makeBriefData(overrides: Partial<ExecutiveBriefData> = {}): ExecutiveBriefData {
  return {
    ...
    topClassifications: [
      { classificationId: "class-01", classificationName: "ضوضاء", categoryId: "cat-class-01", categoryName: "فئة اختبار", classificationPath: "فئة اختبار / ضوضاء", currentCount: 30, previousCount: 25, difference: 5, changeRate: 20.0, shareOfTotal: 30.0 },
      { classificationId: "class-02", classificationName: "بنية تحتية", categoryId: "cat-class-02", categoryName: "فئة اختبار", classificationPath: "فئة اختبار / بنية تحتية", currentCount: 25, previousCount: 20, difference: 5, changeRate: 25.0, shareOfTotal: 25.0 },
    ],
    comparativeTimeline: {
      current: {
