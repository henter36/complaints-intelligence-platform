...
function makeBriefData(overrides: Partial<ExecutiveBriefData> = {}): ExecutiveBriefData {
  return {
    ...
    topClassifications: [
      ...
      { classificationId: "class-02", classificationName: "بنية تحتية", categoryId: "cat-class-02", categoryName: "فئة", classificationPath: "فئة / بنية تحتية", currentCount: 25, previousCount: 20, difference: 5, changeRate: 25.0, shareOfTotal: 25.0 },
    ],
    comparativeTimeline: {
      current: {
