  ...
  try {
    ...
    return NextResponse.json({
      ...
      crossTabs: {
        ...
        regions,
        departments,
        classificationByRegion: classifications.map((classification) => ({ classification })),
        classificationByDepartment: classifications.map((classification) => ({ classification })),
      },
      ...
      anomalies: {
        ...
        classifications: toCount(result.distributions.byClassification),
      },
